...
public class PersonScrollPane extends JScrollPane implements NeroObserver {
	...
	private void generate(Session sessio) {
     ...
     /* Rubenin muokkaamia jännyyksiä */
     //                   JButton varausLisaysNappi = new JButton("Lisää varaus");
     //                   header.add(BorderLayout.EAST, varausLisaysNappi);
     /* Jännyydet päättyvät tähän */
