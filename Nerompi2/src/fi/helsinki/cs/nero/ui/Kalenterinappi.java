...
public class Kalenterinappi extends JCalendarButton{
    ...
    /* // Tekstitarkistus debuggausta varten

                System.out.println("\nVanha: " + evt.getOldValue()
                        + "\nKohde: " + this.getTargetDate()
                        + "\nUusi:  " + evt.getNewValue());
                System.out.println("      - - ASIA: " + evt.getNewValue()
                               + "\n      - -    >: " + this.getTargetDate());
    */
                Date tulos = new Date();
    ...
    /* //Tarkistus 
                    System.out.println("TOIMIIKO ASIAT? \"" + Integer.parseInt(evt.getNewValue().toString().substring(24, 28))+ "\"");
    */     
