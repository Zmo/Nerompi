...
public class ReportsWindow extends javax.swing.JFrame {
    ...
    public ReportsWindow() {
        ...
        initContainers();
        initColumnData();
        // oletusarvoisesti n‰ytet‰‰n henkilˆn‰kym‰
        switchToPeopleData();
    ...
    /**
     * Alustaa GUI taulukossa tarvittavat tiedot ja luo n‰ist‰ kaksi
     * taulukkoa, joiden v‰lill‰ raporttin‰kym‰ss‰ voidaan vaihtaa: 
     * henkilˆ- sek‰ huonetaulukon.
     * Alustaa n‰iden sarakkeiden nimet 
     * sek‰ sarakkeiden datan ja n‰it‰ vastaavat mallit.
     ...
     * ep‰aktiiviset henkilˆt.
     * Joka tapauksessa idea on se, ett‰ taulukkomalli ei koskaan muutu - vain
     * n‰kym‰‰ muutetaan.
     * Taulukkoja on kaksi: henkilˆiden ja huoneiden perusteella listatut.
     * Datan alustamisen lis‰ksi luodaan tarvittavat malit henkilˆdataa varten.
     * @See NeroTableModel
     */
    private void initColumnData() {
        ...
        initPeopleData();
        // henkilˆdata k‰ytt‰‰ DefaultTableModelin aliluokkaa NeroTableModelia
        // joka tarvitsee toimiakseen tietoonsa sen, mihin taulukkoon
        // se liittyy sek‰ taulukon sarakemallin
        // luodaan n‰m‰ ja liitet‰‰n ne malliin
     ...
     * @param type Vertailun tyyppi eli hyv‰ksyt‰‰nkˆ ne rivit joissa p‰iv‰m‰‰r‰
     * on ennen vai j‰lkeen parametrina saadun p‰iv‰m‰‰r‰n
    ...
    /**
     * Selvitet‰‰n, saako olemassaolevan tiedoston yli kirjoittaa. N‰ytet‰‰n
    ...
    /**
     * Asettaa kaikki saamansa sarakkeet n‰kyviksi. 
     * 
    ...
    /**
     * Piilottaa tai n‰ytt‰‰ sarakkeen sen mukaan, onko siihen liittyv‰
     ...
     * 
     * @param regex s‰‰nnˆllinen lauseke, jonka perusteella filterˆid‰‰n
     ...
     * saadun s‰‰nnˆllisen lausekkeen perusteella
    ...
    /**
     * Poistaa k‰ytˆst‰ valitun filterin.
     * 
    ...
    /**
     * Lis‰‰ k‰yttˆˆn filterin.
     * Saa parametrina filterin, jonka lis‰‰ k‰ytˆss‰ olevien filtereiden listaan
     * ja p‰ivitt‰‰ sen j‰lkeen yleisfilterin, joka sis‰lt‰‰ kaikki k‰ytˆss‰ olevat
     * filterit.
    ...
    /**
     * Luo filterin, joka rajaa taulukon datan sen mukaan, mit‰ kaikkia 
     * filttereit‰ on asetettu. 
     * Saa parametrina listan t‰ll‰ hetkell‰ k‰ytˆss‰ olevista filtereist‰ ja 
     * luo t‰m‰n yleisfilterin niiden perusteella.
     * 
     * @param filters lista niist‰ filtereist‰, jotka ovat k‰ytˆss‰
     */
    ...
    /**
     * N‰ytt‰‰ taulukossa kaikki huoneet ja niihin liittyv‰n datan. Asettaa
     * tarvittavat rajoittimet ja sarakevalitsimet pois k‰ytˆst‰ / k‰yttˆˆn sek‰
     * valitsee oletusn‰kym‰ss‰ n‰kyvill‰ olevat sarakkeet n‰ytett‰viksi
     * piilottaen muut.
     */
    ...
    /**
     * N‰ytt‰‰ taulukossa kaikki henkilˆt ja niihin liittyv‰n datan. Asettaa
     * tarvittavat rajoittimet ja sarakevalitsimet pois k‰ytˆst‰ / k‰yttˆˆn sek‰
     * valitsee oletusn‰kym‰ss‰ n‰kyvill‰ olevat sarakkeet n‰ytett‰viksi
     * piilottaen muut.
     */
    ...
    /**
     * Muuttaaa checkboxien tilan siten, ett‰ ne ovat k‰ytˆss‰ tai pois k‰ytˆst‰
     * sen mukaan, mit‰ se saa parametrina.
     *
     * @param components lista niist‰ checkboxeista, joiden tila muutetaan
     * @param b true, jos komponentit pit‰‰ asettaa k‰yttˆˆn ja false jos pois
     */
    ...
    /**
     * Luo taulukon joka sis‰lt‰‰ kaikki henkilˆt ja niihin liittyv‰n datan.
     *
     */
    ...
    /**
     * Luo taulukon, joka sis‰lt‰‰ kaikki tiedossa olevat huoneet ja niihin
     * liittyv‰t tiedot.
     */
    ...
    /**
     * Muuttaa n‰kym‰‰ sen perusteella, pit‰‰kˆ myˆs ep‰aktiiviset henkilˆt
     * n‰ytt‰‰ vai ei.
     * K‰yt‰nnˆss‰ piirt‰‰ uusiksi koko taulukon.
     */
