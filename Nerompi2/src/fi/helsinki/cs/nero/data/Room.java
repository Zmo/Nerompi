...
public class Room {
     ...
     * nimen, huoneen koon ja huoneen kuvauksen. Huoneen työpisteet on
     * asetettava erikseen setPosts-metodilla ennen kuin huonetta voi käyttää.
     *
    ...
    /**
     * Nerompi Lisää huoneelle annetun avainvarauksen
     *
     ...
     * @throws IllegalStateException jos työpisteitä ei ole asetettu
     * setPosts-metodilla
     */
    ...
    public String getWing() {
     ...
     /**
     * Palauttaa huoneen vapaustilan tarkasteltavalla osa-aikavälillä. Huoneen
     * vapaustila määrittyy huoneiden työpisteiden vapaustilan perusteella.
     * Huone on vapaa (FREE), jos se sisältää vähintään
     * Session.getFilterFreePosts() (yleensä 1, mutta voi olla enemmän) vapaata
     * työpistettä. Huone on varattu (OCCUPIED), jos kaikki sen sisältämät
     * työpisteet ovat varattuja. Muussa tapauksessa huone on osittain vapaa
     * (PARTLY_FREE).
     *
