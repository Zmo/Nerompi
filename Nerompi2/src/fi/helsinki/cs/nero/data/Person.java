...
public class Person implements Comparable {
     ...
     * @param reservations Henkilön
     * työpistevaraukset <code>Reservations[]</code> oliona.
...
//        }
    ...
    /**
     * Palauttaa henkilön varauksista sen, jonka päättymispäivä on viimeinen
     *
     * @return Reservation, jonka päivämäärä on viimeinen ja null, jos varauksia
     * ei ole
     */
    ...
    /**
     * Tutkii onko annettujen päivien välillä henkilöllä voimassaolevia
     * työsopimuksia, joiden aikana henkilö ei ole kokonaan virkavapaalla. HUOM:
     * päivien välissa oltava vähintään yksi päivä, peräkkäiset päivät = ei
     * tehdä mitään
     *
